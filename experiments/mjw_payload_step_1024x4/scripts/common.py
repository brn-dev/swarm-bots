...
from experiments.mjw_experiment_common import PolicyVariant, run_experiment as run_mjw_payload_step_experiment
from swarmbots.learn.algos.mat_qcs.mat_qcs_decoder import MATQCSDecoderSelfAttentionMode

EXPERIMENT_RUN_NAME = "mjw_payload_step_1024x4"
...
def run_experiment(
    ...
    run_mjw_payload_step_experiment(
        num_envs=1024,
