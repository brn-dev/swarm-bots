...
EXPERIMENT_RUN_DIR_CANDIDATES = (
    RUNS_DIR / "mjw_wall_medium_1024x4_mat_ind_ablations",
)
...
GROUP_ORDER = (
    ...
    "mat_ind_gsde",
    "mat_ind_no_nop",
    "mat_ind_no_transition_obs",
)
DISPLAY_NAME_OVERRIDES = {
    BASELINE_GROUP: "MAT-Ind + NOP",
    "mat_ind_gsde": "MAT-Ind + NOP, gSDE",
    "mat_ind_no_nop": "MAT-Ind, no NOP",
    "mat_ind_no_transition_obs": "MAT-Ind + NOP, no transition obs",
}
