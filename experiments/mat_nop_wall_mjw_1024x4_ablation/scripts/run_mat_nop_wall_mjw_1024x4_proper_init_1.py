...
def main() -> None:
    ...
    run_ablation(
        variant_name="sticky_lr_beta_nop_proper_init_1",
        ...
        mat_normalization=MATNormalizationConfig(
            ...
            normalize_encoder_tokens=False,
            normalize_query_input=False,
            normalize_context_input=False,
            normalize_memory_input=False,
            normalize_query_tokens=False,
            normalize_context_tokens=False,
            normalize_memory_tokens=False,
