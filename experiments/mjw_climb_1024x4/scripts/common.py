...
from experiments.mjw_experiment_common import PolicyVariant, run_experiment as run_mjw_climb_experiment
from swarmbots.learn.algos.mat_qcs.mat_qcs_decoder import MATQCSDecoderSelfAttentionMode

EXPERIMENT_RUN_NAME = "mjw_climb_1024x4"
