...
GROUP_ORDER = (
    BASELINE_GROUP,
    "mat_dec_gsde_no_transition_obs",
    "mat_dec_no_nop_no_transition_obs",
)
DISPLAY_NAME_OVERRIDES = {
    BASELINE_GROUP: "MAT-Dec + NOP",
    "mat_dec_gsde_no_transition_obs": "MAT-Dec + NOP, gSDE",
    "mat_dec_no_nop_no_transition_obs": "MAT-Dec, no NOP",
}
