...
class RMATQCXPolicyConfig(MATQCXPolicyConfig):
    encoder_config: RMATEncoderConfig = field(default_factory=RMATEncoderConfig)


class RMATQCXPolicy(RMATPolicyMixin, MATQCXPolicy):
    ...
    def __init__(
            ...
            config: RMATQCXPolicyConfig = RMATQCXPolicyConfig(),
    ) -> None:
    ...
    def _generate_rmat_actions(
        ...
        return self._generate_actions(
            ...
            batch_size=augmented_observations.shape[0],
    ...
    def _evaluate_actions(
        ...
        action_tokens = self._encode_decoder_context_tokens(context_observations, context_actions)
