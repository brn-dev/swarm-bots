...
class ObstacleStreetScenario(BaseScenario):
    ...
    def __init__(
            ...
            movement_reward_weight: float = 1e-2,
            height_reward_weight: float = 2e-3,
            connectors_stayed_active_reward_weight: float = 1e-4,
            connectors_successfully_activated_reward_weight: float = 1e-3,
            connectors_unsuccessfully_activated_reward_weight: float = -0e-5,
            connectors_deactivated_reward_weight: float = -1.2e-3,
