...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RMATIndPolicy, RMATIndPolicyConfig),
    ],
)
def test_rmat_rollout_and_training_use_env_major_tbptt_rows(
        policy_cls: type[RMATQCSPolicy | RMATQCCPolicy | RMATQCXPolicy | RMATIndPolicy],
        policy_config_cls: type[RMATQCSPolicyConfig | RMATQCCPolicyConfig | RMATQCXPolicyConfig | RMATIndPolicyConfig],
) -> None:
