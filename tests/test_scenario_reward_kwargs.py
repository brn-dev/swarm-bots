...
def test_mj_and_mjw_wall_difficulty_kwargs_use_shared_defaults() -> None:
    ...
    assert scenario_presets.PO_WALL_MEDIUM_SCENARIO_KWARGS == PO_WALL_MEDIUM_SCENARIO_KWARGS
    ...
    assert mjw_scenario_presets.PO_WALL_MEDIUM_SCENARIO_KWARGS == PO_WALL_MEDIUM_SCENARIO_KWARGS
