...
def main() -> None:
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("run_mat_nop_move_to_dual_payload_mjw.py requires CUDA.")
    ...
    run_dir = make_run_dir("mat_nop_swarm_bots_move_to_dual_payload_mjw", run_id)
    ...
    run_with_discord_notification(
        run_name=f"mat_nop_move_to_dual_payload_mjw/{run_id}",
        run_dir=run_dir,
