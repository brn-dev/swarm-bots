...
def main() -> None:
    ...
    # load_path = "../runs/mat_nop_swarm_bots_payload_mjw/2026-04-18_00-00-00/models/model_123456_steps_stopped.pt"
    ...
    run_dir = f"../runs/mat_nop_swarm_bots_payload_mjw/{run_id}/"
    save_optimizer = True
