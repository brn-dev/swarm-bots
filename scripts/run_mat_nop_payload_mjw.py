...
def main() -> None:
    ...
    # load_path = make_run_dir("mat_nop_swarm_bots_payload_mjw", "2026-04-18_00-00-00") / "models" / "model_123456_steps_stopped.pt"
    ...
    run_dir = make_run_dir("mat_nop_swarm_bots_payload_mjw", run_id)
    save_optimizer = True
    ...
    run_with_discord_notification(
        run_name=f"mat_nop_payload_mjw/{run_id}",
        run_dir=run_dir,
        total_timesteps=total_timesteps,
        algorithm=ppo,
