...
def main() -> None:
    ...
    # load_path = make_run_dir("mat_nop_swarm_bots_wall_mjw", "2026-04-18_00-00-00") / "models" / "model_123456_steps_stopped.pt"
    ...
    run_dir = make_run_dir("mat_nop_swarm_bots_wall_mjw", run_id)
    save_optimizer = True
