...
- Potential-style scenario reward deltas use `potential_reward_discount_factor * current - previous`; it defaults to `1.0` in common scenario kwargs, while medium wall sets it to PPO gamma `0.99`.
