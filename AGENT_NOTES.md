...
- MAT/NOP module configs and the 1024x4 MJW ablation helper default to the `proper_init_1` setup: hidden/projection/transformer-FF gains `1.0`, output/prediction/action gains `0.01`. MATOrig still uses its separate reference-style initializer.
