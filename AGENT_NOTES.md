...
- Shared MJ/MJW scenario preset defaults live in `swarmbots/scenario_presets_kwargs.py`; keep mirrored common, wall, payload, and move-to reward kwargs there instead of duplicating them in `scenario_presets.py` / `mjw_scenario_presets.py`.
