...
- All sign-magnitude distributions interpret the negative unit-interval sample as its magnitude (`action = -U`); sampling and `log_prob` share this transform through the common base.
