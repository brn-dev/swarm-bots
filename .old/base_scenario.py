...
#         connectors_reward += state['num_connectors_successfully_activated'] * rw[
#             'connectors_successfully_activated_reward_weight']
#         connectors_reward += state['num_connectors_unsuccessfully_activated'] * rw[
